...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    site_name: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'DermaSynergy'>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    accent: Schema.Attribute.Enumeration<['green', 'blue']> &
      Schema.Attribute.DefaultTo<'green'>;
    benefits: Schema.Attribute.Component<'shared.icon-text', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    gallery: Schema.Attribute.Media<'images', true>;
    how_to_use: Schema.Attribute.Component<'shared.title-text', true>;
    ingredients: Schema.Attribute.Component<'shared.list-item', true>;
    ...
    specs: Schema.Attribute.Component<'shared.stat', true>;
    subtitle: Schema.Attribute.String;
    tags: Schema.Attribute.Component<'shared.list-item', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
